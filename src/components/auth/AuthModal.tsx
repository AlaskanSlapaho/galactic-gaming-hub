        ...
        <div className="space-y-6 py-4">
          ...
          <div className="bg-zinc-800 p-4 rounded-md border border-zinc-700">
            <div className="flex gap-3">
              <AlertCircle className="text-yellow-500 h-5 w-5 flex-shrink-0 mt-0.5" />
              <div className="text-sm text-zinc-300">
                <p>Login using your Discord account to access the casino. Your Discord balance will be available for deposits and withdrawals.</p>
              </div>
            </div>
          </div>
        </div>
